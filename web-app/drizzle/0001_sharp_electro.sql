...
CREATE TYPE "public"."room_member_role" AS ENUM('host', 'participant');--> statement-breakpoint
...
CREATE TABLE "room_members" (
	...
	"role" "room_member_role" DEFAULT 'participant' NOT NULL,
...
CREATE TABLE "news_articles" (
	...
	"source_domain" text,
	"image_url" text,
	"ground_truth_classification" "ml_target_type" DEFAULT 'reliable' NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL
);
--> statement-breakpoint
