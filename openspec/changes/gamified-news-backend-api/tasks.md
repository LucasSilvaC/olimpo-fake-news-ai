...
- [x] 1.2 Configurar clients compartilhados em `src/app/server/shared`: Drizzle DB client (`shared/database/client.ts`) e Redis singleton (`shared/redis/client.ts`) com leitura de variáveis de ambiente
- [x] 1.3 Definir Drizzle schemas e enums (`users`, `rooms`, `room_members`, `room_playlist_items`, `news_articles`, `news_analyses`, `news_votes`, `global_challenges`, `global_challenge_answers`) em `src/app/server/shared/database/schemas` e exportar no index
...
- [ ] 2.1 Criar estrutura da feature em `src/app/server/features/auth/` com `entities/`, `usecase/`, `repositories/`, `actions/` e `tests/`
...
- [ ] 3.1 Criar estrutura da feature em `src/app/server/features/ai-feedback/` com `entities/`, `usecase/`, `repositories/` e `tests/`
...
- [ ] 4.1 Criar estrutura da feature em `src/app/server/features/rooms/` com `entities/`, `usecase/`, `repositories/`, `actions/` e `tests/`
...
- [ ] 5.1 Criar estrutura da feature em `src/app/server/features/news-voting/` com `entities/`, `usecase/`, `repositories/`, `actions/` e `tests/`
...
- [ ] 6.1 Criar estrutura da feature em `src/app/server/features/realtime-events/` com `usecase/`, `repositories/` e `tests/`
...
- [ ] 7.1 Criar estrutura da feature em `src/app/server/features/global-challenges/` com `entities/`, `usecase/`, `repositories/`, `actions/` e `tests/`
